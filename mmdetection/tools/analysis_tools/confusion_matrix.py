...
def plot_confusion_matrix(confusion_matrix,
    ...
    fig, ax = plt.subplots(
        figsize=(num_classes, 0.75 * num_classes * 0.85), dpi=300)
    ...
    plt.setp(
        ax.get_xticklabels(), rotation=45, ha='left', rotation_mode='anchor', fontsize=5)
    ...
    if save_dir is not None:
        plt.savefig(
            os.path.join(save_dir, 'confusion_matrix.png'), format='png',  dpi=300)
    if show:
        plt.show()
