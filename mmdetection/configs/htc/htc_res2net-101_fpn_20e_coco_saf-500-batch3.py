...
load_from = 'mmdetection/configs/htc/htc_r2_101_fpn_20e_coco-3a8d2112.pth'
log_level = 'INFO'
...
optim_wrapper = dict(
    optimizer=dict(lr=0.00375, momentum=0.9, type='SGD', weight_decay=0.0001),
    type='OptimWrapper')
param_scheduler = [
    dict(
...
work_dir = './tutorial_exps/500-epochs-batch3'
