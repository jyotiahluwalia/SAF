...
backend_args = None
data_root = 'mmdetection/data/saf24/'
...
default_hooks = dict(
    ...
    logger=dict(interval=8, type='LoggerHook'),
...
test_evaluator = dict(
    ann_file='mmdetection/data/saf24/val/annotation_coco.json',
    backend_args=None,
    classwise=True,
    format_only=False,
    metric=[
...
train_cfg = dict(max_epochs=60, type='EpochBasedTrainLoop', val_interval=3)
...
work_dir = './tutorial_exps/60-new-data-batch2'
